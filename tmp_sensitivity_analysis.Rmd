...
tmp_forcing_data %>% 
  ...
  theme_minimal(base_size = 24) -> p_forcing_timeseries
...
bind_rows(runlist) %>% 
  ...
  theme_minimal(base_size = 24) -> p_param_dist
...
ribbon_plot_data %>%
  ...
  theme_minimal(base_size = 24) -> p_model_output
...
bind_rows(out) %>%
  ...
  coord_cartesian(ylim = c(0.97, 1.0)) +
  ...
  theme(legend.position = "bottom") -> p_relimp

```

```{r save plots, eval=FALSE, include=FALSE}

ggsave("./figures/AGU23/relimp.jpg", plot = p_relimp, height = 9, width = 15, dpi = "retina")

ggsave("./figures/AGU23/model_output.jpg", plot = p_model_output, height = 9, width = 15, dpi = "retina")

ggsave("./figures/AGU23/param_dist.jpg", plot = p_param_dist, height = 6, width = 15, dpi = "retina")

ggsave("./figures/AGU23/forcing_timeseries.jpg", plot = p_forcing_timeseries, height = 6, width = 15, dpi = "retina")
