...
tmp_forcing_data %>% 
  ...
  theme_minimal(base_size = 24) -> forcing_timeseries
...
bind_rows(runlist) %>% 
  ...
  theme_minimal(base_size = 24) -> param_dist
...
ribbon_plot_data %>%
  ...
  theme_minimal(base_size = 24) -> model_output
...
bind_rows(out) %>%
  ...
  theme(legend.position = "bottom") -> relimp

```

```{r save plots, eval=FALSE, include=FALSE}

ggsave("./figures/AGU23/relimp.jpg", plot = relimp, height = 9, width = 15, dpi = "retina")

ggsave("./figures/AGU23/model_output.jpg", plot = model_output, height = 9, width = 15, dpi = "retina")

ggsave("./figures/AGU23/param_dist.jpg", plot = param_dist, height = 6, width = 15, dpi = "retina")

ggsave("./figures/AGU23/forcing_timeseries.jpg", plot = forcing_timeseries, height = 6, width = 15, dpi = "retina")
